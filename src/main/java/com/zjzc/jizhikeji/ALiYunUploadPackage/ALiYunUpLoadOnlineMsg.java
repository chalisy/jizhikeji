package com.zjzc.jizhikeji.ALiYunUploadPackage;
...
public class ALiYunUpLoadOnlineMsg {
    public String upload(String msg){
        ...
        try{
            CloudQueue queue = client.getQueueRef("onlineQueueTest");// replace with your queue name
                Message message = new Message();
                message.setMessageBody(msg); // use your own message body here
